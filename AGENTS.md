...
- Julia compatibility is targeted at **1.10** (current LTS). CI lives in `.github/workflows/tests.yml` and runs on Linux (Ubuntu, x64) for Julia `1` and `1.10`, triggered by pushes to `main` (and tags) or pull requests targeting `main`.
